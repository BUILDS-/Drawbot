...
char image[]="0010001100101101000110101" //will convert image to a string of 1 and 0 MATLAVB/GNU Octave, script for that mostly done
...
int county=0;
int currentPixel=0;
int imageSize=5;   //here we assume a 5x5 pixel "image"
